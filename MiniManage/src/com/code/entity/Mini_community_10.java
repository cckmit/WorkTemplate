...
@Entity
@Page
public class Mini_community_10 {
	@PrimaryKey
	@Column(name = "game_id")
	...
	public static String importFromExcel(Vector<Vector<Object>> vector) {
		String deletesql = "delete from mini_community_10";
		MiniGamebackDao.instance.execSQLCMDInfo(deletesql);
		StringBuilder result = new StringBuilder();
		boolean isValid = true;
		Vector<Mini_community_10> importList = new Vector<>();
		...
		for (Vector<Object> lineVector : vector) {
			...
			Mini_community_10 manual = new Mini_community_10();
