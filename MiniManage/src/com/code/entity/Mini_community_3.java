...
public class Mini_community_3 {
	...
	public static String importFromExcel(Vector<Vector<Object>> vector) {
		String deletesql = "delete from mini_community_3";
		MiniGamebackDao.instance.execSQLCMDInfo(deletesql);
		StringBuilder result = new StringBuilder();
		boolean isValid = true;
		Vector<Mini_community_3> importList = new Vector<>();
		...
		for (Vector<Object> lineVector : vector) {
			...
			Mini_community_3 manual = new Mini_community_3();
