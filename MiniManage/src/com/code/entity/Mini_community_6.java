...
public class Mini_community_6 {
	...
	public static String importFromExcel(Vector<Vector<Object>> vector) {
		String deletesql = "delete from mini_community_6";
		MiniGamebackDao.instance.execSQLCMDInfo(deletesql);
		StringBuilder result = new StringBuilder();
		boolean isValid = true;
		Vector<Mini_community_6> importList = new Vector<>();
		...
		for (Vector<Object> lineVector : vector) {
			...
			Mini_community_6 manual = new Mini_community_6();
