...
public class Mini_community_9 {
	...
	public static String importFromExcel(Vector<Vector<Object>> vector) {
		String deletesql = "delete from mini_community_9";
		MiniGamebackDao.instance.execSQLCMDInfo(deletesql);
		StringBuilder result = new StringBuilder();
		boolean isValid = true;
		Vector<Mini_community_9> importList = new Vector<>();
		...
		for (Vector<Object> lineVector : vector) {
			...
			Mini_community_9 manual = new Mini_community_9();
