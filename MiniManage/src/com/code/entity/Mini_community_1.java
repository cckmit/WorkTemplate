...
public class Mini_community_1 {
	...
	public static String importFromExcel(Vector<Vector<Object>> vector) {
		String deletesql = "delete from mini_community_1";
		MiniGamebackDao.instance.execSQLCMDInfo(deletesql);
		StringBuilder result = new StringBuilder();
		boolean isValid = true;
		Vector<Mini_community_1> importList = new Vector<>();
		...
		for (Vector<Object> lineVector : vector) {
			...
			Mini_community_1 manual = new Mini_community_1();
	...
	public String toString() {
		return "Mini_community_1 [game_id=" + game_id + ", pos=" + pos + ", game_name=" + game_name + ", activeUp="
				+ activeUp + ", game_spread=" + game_spread + ", game_sorttype_shop=" + game_sorttype_shop
				+ ", isblock_stores=" + isblock_stores + "]";
	}
