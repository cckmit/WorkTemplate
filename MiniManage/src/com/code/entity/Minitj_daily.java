...
//	public int daily_video_req;
    ...
    @Comments(name = "插屏收入")
    public BigDecimal daily_income_screen;
    ...
    public static void addSumLine(Vector<Minitj_daily> list) {
        ...
        BigDecimal daily_income_screen = new BigDecimal(0);
        for (Minitj_daily daily1 : list) {
            ...
            daily_income_screen = daily1.daily_income_screen != null ? daily_income_screen.add(daily1.daily_income_screen) : daily_income_screen;
        }
        daily.daily_date = "总计";
        ...
        daily.daily_income_screen = daily_income_screen;
        list.add(daily);
    }
}
