...
public class Mini_community_7 {
	...
	public static String importFromExcel(Vector<Vector<Object>> vector) {
		String deletesql = "delete from mini_community_7";
		MiniGamebackDao.instance.execSQLCMDInfo(deletesql);
		StringBuilder result = new StringBuilder();
		boolean isValid = true;
		Vector<Mini_community_7> importList = new Vector<>();
		...
		for (Vector<Object> lineVector : vector) {
			...
			Mini_community_7 manual = new Mini_community_7();
