 ...
 *
 */
public class OpDbPersieValue {
    public interface NAME {
        static final String Persie_Value = "db_persieValue.xml";
    }

    public interface DB_ALIAS {
        static final String PersieValue_ALIAS = "persie_value";
    }
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            conn = DriverManager.getConnection("proxool." + DB_ALIAS.PersieValue_ALIAS);
    ...
    public static void init() {
        try {
            {
                InputStream in = OpDbConnector.class.getResourceAsStream("/" + NAME.Persie_Value);
