 ...
 * 
 */
public class OpDbGamePackage
{
	public interface NAME{static final String MINI_PACKAGE = "db_package.xml";}

	public interface DB_ALIAS{
	static final String PMINIGAMEBACK_ALIAS ="mini_package";
}
	...
	public static Connection getConnection()
	{
		...
		try
		{
			...
			conn = DriverManager.getConnection("proxool." + DB_ALIAS.PMINIGAMEBACK_ALIAS);
	...
	public static void init()
	{
		...
		{
			{
				InputStream in = OpDbConnector.class.getResourceAsStream("/" + NAME.MINI_PACKAGE);
