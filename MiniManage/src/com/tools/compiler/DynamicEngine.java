...
public class DynamicEngine
{
	...
	public static void check()
	{
		...
		if (null == compiler)
		{
			System.out.println("DynamicEngine：compiler is null!");
			System.out.println("DynamicEngine：home path = "
					+ System.getProperty("java.home"));
			System.out.println("DynamicEngine：class path = "
					+ System.getProperty("java.class.path"));
			return;
		}
		System.out.println("compiler is ok!");
	}
			...
			throws IllegalAccessException, InstantiationException, IOException
	{
		...
		System.out.println("DynamicEngine：" + this.classpath);
