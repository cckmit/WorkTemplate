...
$.post(operatorurl+"?type=flush",{},function(c){$.messager.show({title:"提示消息",msg:c});},'html');
}
...
var colum = opt[0][i];
if(colum.sum) {
footer['sum'] = footer['sum'] + sum(colum.field) + ',';
}
if(colum.avg) {
footer['avg'] = footer['avg'] + avg(colum.field) + ',';
}
if(colum.max) {
footer['max'] = footer['max'] + max(colum.field) + ',';
}
if(colum.min) {
footer['min'] = footer['min'] + min(colum.field) + ',';
}
}
