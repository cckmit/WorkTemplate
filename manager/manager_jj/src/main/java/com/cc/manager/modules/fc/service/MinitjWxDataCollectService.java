 ...
 */
@Service
public class MinitjWxDataCollectService extends BaseCrudService<MinitjWx, MinitjWxMapper> {
...
//            }
    ...
    @Autowired
    public void seWxDailyVisitTrendService(WxDailyVisitTrendService wxDailyVisitTrendService) {
        this.wxDailyVisitTrendService = wxDailyVisitTrendService;
    }

    @Autowired
    public void seWxDailySummaryService(WxDailySummaryService wxDailySummaryService) {
