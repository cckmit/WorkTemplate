 ...
 */
@WebServlet(urlPatterns = {"/logAds", "/log/ad"})
public class AdLogServlet extends CmServletMain implements Serializable {
    ...
    protected JSONObject handle(HttpServletRequest requestObject, JSONObject requestPackage) {
        // 记录广告提交日志
        AdLog.info("[PRIMARY]" + requestPackage.toJSONString());
        // 通知客户端数据记录成功
