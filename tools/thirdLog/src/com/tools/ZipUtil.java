...
public class ZipUtil {
     ...
     * @return
     */
    public static List<String> unzip(File zipFileName, String dstPath) {
        File existsDstPath = new File(dstPath);
        if (!existsDstPath.exists())
            existsDstPath.mkdir();

        // zip解压文件
        List<String> unzipFile = new ArrayList<String>();
        try {
            ...
            while ((zipEntry = zipInputStream.getNextEntry()) != null) {
                ...
                unzipFile.add(file.getCanonicalPath());
