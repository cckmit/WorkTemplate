...
public class SecondDataBaseConfig {
     ...
     * dao层的包路径
     */
    static final String PACKAGE = "com.blazefire.dao.second.mapper";
    /**
     * mapper文件的相对路径
     */
    private static final String MAPPER_LOCATION = "classpath:mybatisMapper/second/*.xml";
    ...
    public DataSource secondDataSource() throws SQLException {
        System.out.println("从数据库加载开始 -> " + url);
