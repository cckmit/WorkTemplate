...
public class ConfigAdCombinationController {
     ...
     */
    @ResponseBody
    @PostMapping(value = "/configAdCombination/copy")
    public PostResult copyConfigAdSource(@RequestBody ConfigAdCombination configAdCombination) {
        return this.adCombinationService.copy(configAdCombination);
    }
